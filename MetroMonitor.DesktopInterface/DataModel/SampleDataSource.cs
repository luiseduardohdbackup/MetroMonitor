...
namespace MetroMonitor.DesktopInterface.Data
{
    /// <summary>
    ...
    public abstract class SampleDataCommon : MetroMonitor.DesktopInterface.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            group1.Items.Add(new SampleDataItem("Group-1-Item-1",
                    "Edit Counters",
                    "Item Subtitle: Edit predefined counters",
                    "Assets/LightGray.png",
                    "Edit predefined counters",
                    ITEM_CONTENT,
                    group1));
            group1.Items.Add(new SampleDataItem("Group-1-Item-2",
                    "Add Counters",
                    "Item Subtitle: Add Counters",
                    "Assets/DarkGray.png",
                    "Add Performance Counters to a predefined device",
                    ITEM_CONTENT,
                    group1));
            group1.Items.Add(new SampleDataItem("Group-1-Item-3",
                    ...
                    "Add devices running the MetroMonitoring Service Solution",
                    ITEM_CONTENT,
                    group1));
